...
#define EXAMPLESENSOR_INIT(i)                                                                                          \
    ...
    static const struct examplesensor_config examplesensor_config_##i = {                                              \
        .input = GPIO_DT_SPEC_INST_GET(i, input_gpios),                                                                \
                                                                                                                       ...
                                                                                                                       \
    DEVICE_DT_INST_DEFINE(i, examplesensor_init, NULL, &examplesensor_data_##i, &examplesensor_config_##i,             \
                          POST_KERNEL, CONFIG_SENSOR_INIT_PRIORITY, &examplesensor_api);
